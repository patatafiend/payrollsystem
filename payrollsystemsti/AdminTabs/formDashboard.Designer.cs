namespace payrollsystemsti
{
    partial class formDashboard
    {
        ...
        private void InitializeComponent()
        {
			...
			this.attendanceMonitoringPnl = new System.Windows.Forms.Panel();
			...
			this.attendanceMonitoringPnl.SuspendLayout();
			...
			this.sideBar.Controls.Add(this.attendanceMonitoringPnl);
			...
			// 
			// attendanceMonitoringPnl
			// 
			this.attendanceMonitoringPnl.BackColor = System.Drawing.Color.Transparent;
			this.attendanceMonitoringPnl.Controls.Add(this.btnAttendanceM);
			this.attendanceMonitoringPnl.Location = new System.Drawing.Point(0, 519);
			this.attendanceMonitoringPnl.Margin = new System.Windows.Forms.Padding(0, 3, 0, 0);
			this.attendanceMonitoringPnl.Name = "attendanceMonitoringPnl";
			this.attendanceMonitoringPnl.Padding = new System.Windows.Forms.Padding(25, 0, 0, 0);
			this.attendanceMonitoringPnl.Size = new System.Drawing.Size(185, 55);
			this.attendanceMonitoringPnl.TabIndex = 12;
			// 
			// btnAttendanceM
			// 
			...
			this.enrollFingerprintPnl.Location = new System.Drawing.Point(0, 577);
			...
			this.attendanceMonitoringPnl.ResumeLayout(false);
        ...
        private System.Windows.Forms.Panel attendanceMonitoringPnl;
